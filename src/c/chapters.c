...
void chapter(struct Entities* entities, struct ItemArray* items, int chapter) {
    ...
    switch (chapter) {
        ...
        case 2:
            ...
            break;
        case 3:
            chapter3(entities, items);
            break;
        case 4:
            chapter4(entities, items);
            break;
        case 5:
            chapter5(entities, items);
            break;
        case 6:
            chapter6(entities, items);
            break;
        case 7:
            chapter7(entities, items);
            break;
        case 8:
            chapter8(entities, items);
            break;
        case 9:
            chapter9(entities, items);
            break;
        case 10:
            chapter10(entities, items);
            break;
        case 11:
            chapter11(entities, items);
            break;
        case 12:
            chapter12(entities, items);
            break;
        case 13:
            chapter13(entities, items);
            break;
        case 14:
            chapter14(entities, items);
            break;
        case 15:
            chapter15(entities, items);
            break;
        case 16:
            chapter16(entities, items);
            break;
        case 17:
            chapter17(entities, items);
            break;
        case 18:
            chapter18(entities, items);
            break;
        case 19:
            chapter19(entities, items);
            break;
        case 20:
            chapter20(entities, items);
            break;
        default:
